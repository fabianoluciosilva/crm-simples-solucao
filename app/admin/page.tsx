...
export default function AdminPage() {
  ...
  const clientesAgrupados = useMemo(() => {
    ...
    clientesBase.forEach(c => {
      mapa.set(`ID_${c.id}`, { ...c, isOficial: true, propostas: [], contratos: [], tarefas: [], interacoes: [] });
    });
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <aside className="sidebar">
        ...
        <div style={{ padding: "16px 20px", borderTop: "1px solid var(--border-light)" }}>
          ...
          <div style={{ fontSize: "10px", color: "var(--text-tertiary)", marginTop: 10, textAlign: "center" }}>v2.3 Modular</div>
        </div>
      </aside>
