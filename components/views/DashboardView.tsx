...
interface DashboardViewProps {
  ...
  tarefasUrgentes: any[];
  mudarAba: (aba: any) => void;
  pFiltradas: any[];
  dadosMotivosPerda: any[];
...
export const DashboardView = ({
  ...
  mudarAba, pFiltradas, dadosMotivosPerda, dadosPipelineMensal
}: DashboardViewProps) => {
  return (
    <>
      <div className="grid-metrics">
        {isAdmin && <MetricCard label="MRR ATIVO" value={fmt(mrrAtivo)} borderColor="#22c55e" icon="💰" sub={`${mrrAtivo > 0 ? 'Contratos ativos' : ''}`} />}
