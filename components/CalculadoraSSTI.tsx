...
interface PropostaDB {
  id: number; created_at: string; numero: string; cliente: string; contato: string; valor: number; dados: any;
}
...
export const CalculadoraSSTI = () => {
  ...
  // Novo estado para as licenças customizadas
  ...
  const imprimirESalvar = useCallback(async () => {
    ...
    const { data: novaProp, error } = await supabase
      ...
      .insert([{
        ...
        contato: nomeContato,
        valor: valorFinal,
        dados: { qtd, precos, desconto, obs, licencasCustom } // Inclui as licenças na memória
      }])
      .select();
  ...
  }, [cliente, contato, obs, valorFinal, qtd, precos, desconto, licencasCustom]);
    ...
    <div style={{ minHeight: "100vh", background: "#080f1e", color: "#fff" }}>
      ...
      <div className="calc-grid">
        ...
        <div>
          ...
          {/* NOVO: LICENCIAMENTO CUSTOMIZÁVEL */}
          <div className="card">
        ...
        <div style={{ position: "sticky", top: 24, alignSelf: "start" }}>
          ...
          <button className="btn btn-outline" onClick={() => { setCliente(""); setContato(""); setDesconto(0); setObs(""); setLicencasCustom([]); setQtd({ computador: 0, servidor: 0, backupLocalEst: 0, backupLocalSrv: 0, backupNuvemEst: 0, backupNuvemSrv: 0, firewall: 0, cftv: 0, pabx: 0, tecnicoHora: 0, deslocamentoKm: 0, deslocamentoVisitas: 1 }); }}>↺ Limpar Gerador</button>
